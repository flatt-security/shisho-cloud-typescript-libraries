 ...
 * @example
 * ```typescript
 * import { security_group_changes } from "https://deno.land/x/shisho_cloud_policy_helpers/decision/aws/logmetric/logmetric_security_group_changes.gen.ts";
...
export type SecurityGroupChangesDefaultParams = {
