 ...
 * @example
 * ```typescript
 * import { console_root_user_usage } from "https://deno.land/x/shisho_cloud_policy_helpers/decision/aws/logmetric/logmetric_console_root_user_usage.gen.ts";
...
export type ConsoleRootUserUsageDefaultParams = {
