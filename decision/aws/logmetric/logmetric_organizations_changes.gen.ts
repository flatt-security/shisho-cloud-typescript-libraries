...
/** Ensure a log metric filter and alarm exist for AWS Organizations changes
  ...
  * @example
  * ```typescript
  * import { organizations_changes } from "https://deno.land/x/shisho-cloud-sdk/decision/aws/logmetric/logmetric_organizations_changes.gen.ts"
...
export type OrganizationsChangesDefaultParams = { resource_exceptions?: string[] }
