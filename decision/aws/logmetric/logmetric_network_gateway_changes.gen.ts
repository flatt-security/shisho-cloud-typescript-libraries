...
/** Ensure a log metric filter and alarm exist for changes to network gateways
  ...
  * @example
  * ```typescript
  * import { network_gateway_changes } from "https://deno.land/x/shisho-cloud-sdk/decision/aws/logmetric/logmetric_network_gateway_changes.gen.ts"
...
export type NetworkGatewayChangesDefaultParams = { resource_exceptions?: string[] }
