 ...
 * @example
 * ```typescript
 * import { root_user_hardware_mfa } from "https://deno.land/x/shisho_cloud_policy_helpers/decision/aws/iam/iam_root_user_hardware_mfa.gen.ts";
...
export type RootUserHardwareMfaDefaultParams = {
