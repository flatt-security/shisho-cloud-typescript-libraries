 ...
 * @example
 * ```typescript
 * import { user_available_access_keys } from "https://deno.land/x/shisho_cloud_policy_helpers/decision/aws/iam/iam_user_available_access_keys.gen.ts";
...
export const user_available_access_keys = (
  ...
  "header": {
    ...
    "type": as_decision_type(
      user_available_access_keys_allowed(decision, params),
    ),
  },
...
export type UserAvailableAccessKeysDefaultParams = {
