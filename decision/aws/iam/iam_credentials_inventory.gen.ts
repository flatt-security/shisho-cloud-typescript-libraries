...
/** Ensure credentials unused for specific days are disabled
  ...
  * @example
  * ```typescript
  * import { credentials_inventory } from "https://deno.land/x/shisho-cloud-sdk/decision/aws/iam/iam_credentials_inventory.gen.ts"
...
export type CredentialsInventoryDefaultParams = { resource_exceptions?: string[] }
