 ...
 * @example
 * ```typescript
 * import { account_alternate_contact } from "https://deno.land/x/shisho_cloud_policy_helpers/decision/aws/iam/iam_account_alternate_contact.gen.ts";
...
export const account_alternate_contact = (
  ...
  "header": {
    ...
    "type": as_decision_type(
      account_alternate_contact_allowed(decision, params),
    ),
  },
...
export type AccountAlternateContactDefaultParams = {
