...
/** Ensure that all the expired SSL/TLS certificates stored in AWS IAM are removed
  ...
  * @example
  * ```typescript
  * import { server_certificates } from "https://deno.land/x/shisho-cloud-sdk/decision/aws/iam/iam_server_certificates.gen.ts"
...
export type ServerCertificatesDefaultParams = { resource_exceptions?: string[] }
