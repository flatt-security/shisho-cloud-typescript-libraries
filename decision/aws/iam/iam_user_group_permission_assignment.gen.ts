...
/** Ensure IAM users receive permissions only through groups
  ...
  * @example
  * ```typescript
  * import { user_group_permission_assignment } from "https://deno.land/x/shisho-cloud-sdk/decision/aws/iam/iam_user_group_permission_assignment.gen.ts"
...
export const user_group_permission_assignment = (
  ...
  "header": {
    ...
    "type": as_decision_type(user_group_permission_assignment_allowed(decision, params)),
  },
...
export type UserGroupPermissionAssignmentDefaultParams = { resource_exceptions?: string[] }

const user_group_permission_assignment_kind = "aws_iam_user_group_permission_assignment"
