 ...
 * @example
 * ```typescript
 * import { container_fs_permission } from "https://deno.land/x/shisho_cloud_policy_helpers/decision/aws/ecs/ecs_container_fs_permission.gen.ts";
...
export type ContainerFsPermissionDefaultParams = {
