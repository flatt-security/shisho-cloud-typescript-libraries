...
/** Ensure ECS containers run as non-privileged
  ...
  * @example
  * ```typescript
  * import { container_privilege } from "https://deno.land/x/shisho-cloud-sdk/decision/aws/ecs/ecs_container_privilege.gen.ts"
...
export type ContainerPrivilegeDefaultParams = { resource_exceptions?: string[] }
