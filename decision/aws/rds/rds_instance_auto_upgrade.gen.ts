...
/** Ensure auto minor version upgrade feature is enabled for RDS instances
  ...
  * @example
  * ```typescript
  * import { instance_auto_upgrade } from "https://deno.land/x/shisho-cloud-sdk/decision/aws/rds/rds_instance_auto_upgrade.gen.ts"
...
export type InstanceAutoUpgradeDefaultParams = { resource_exceptions?: string[] }
