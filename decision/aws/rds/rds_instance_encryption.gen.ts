...
/** Ensure encryption is enabled for RDS instances
  ...
  * @example
  * ```typescript
  * import { instance_encryption } from "https://deno.land/x/shisho-cloud-sdk/decision/aws/rds/rds_instance_encryption.gen.ts"
...
export type InstanceEncryptionDefaultParams = { resource_exceptions?: string[] }
