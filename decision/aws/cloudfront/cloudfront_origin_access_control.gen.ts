...
/** Ensure CloudFront distributions with S3 backends use origin access control enabled
  ...
  * @example
  * ```typescript
  * import { origin_access_control } from "https://deno.land/x/shisho-cloud-sdk/decision/aws/cloudfront/cloudfront_origin_access_control.gen.ts"
...
export type OriginAccessControlDefaultParams = { resource_exceptions?: string[] }
