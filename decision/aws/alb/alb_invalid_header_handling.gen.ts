 ...
 * @example
 * ```typescript
 * import { invalid_header_handling } from "https://deno.land/x/shisho_cloud_policy_helpers/decision/aws/alb/alb_invalid_header_handling.gen.ts";
...
export type InvalidHeaderHandlingDefaultParams = {
