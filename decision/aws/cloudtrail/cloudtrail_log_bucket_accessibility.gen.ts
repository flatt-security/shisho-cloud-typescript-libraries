...
/** Ensure the S3 bucket for CloudTrail logs is not publicly accessible
  ...
  * @example
  * ```typescript
  * import { log_bucket_accessibility } from "https://deno.land/x/shisho-cloud-sdk/decision/aws/cloudtrail/cloudtrail_log_bucket_accessibility.gen.ts"
...
export const log_bucket_accessibility = (
  ...
  "header": {
    ...
    "type": as_decision_type(log_bucket_accessibility_allowed(decision, params)),
  },
...
export type LogBucketAccessibilityDefaultParams = { resource_exceptions?: string[] }
