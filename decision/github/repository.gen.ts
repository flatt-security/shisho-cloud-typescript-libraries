...
import { as_decision_type, Decision, is_excepted, Severity, SEVERITY_INFO, SEVERITY_LOW, SEVERITY_MEDIUM } from "../mod.ts"
...
/** Ensure the deletion of protected branches is limited
  ...
  * @example
  * ```typescript
  * import { branch_deletion_policy } from "https://deno.land/x/shisho-cloud-sdk/decision/github/repository.gen.ts"
...
export type BranchDeletionPolicyDefaultParams = { resource_exceptions?: string[] }
...
/** Ensure code owner’s review is required when a change affects owned code
  ...
  * @example
  * ```typescript
  * import { code_owners_review_policy } from "https://deno.land/x/shisho-cloud-sdk/decision/github/repository.gen.ts"
  * import { Decision, DecisionPolicy } from "https://deno.land/x/shisho-cloud-sdk/decision/mod.ts"
  * import { wrap_decision_policy } from "https://deno.land/x/shisho-cloud-sdk/decision/raw.ts"
  * import { convert_input, Input } from "./input.ts"
  * 
...
export const code_owners_review_policy = (
  ...
  "header": {
    ...
    "type": as_decision_type(code_owners_review_policy_allowed(decision, params)),
  },
  "payload": decision.payload,
})
...
export type CodeOwnersReviewPolicyDefaultParams = { resource_exceptions?: string[] }
...
/** Ensure verification of signed commits for new changes before merging
  ...
  * @example
  * ```typescript
  * import { commit_signature_policy } from "https://deno.land/x/shisho-cloud-sdk/decision/github/repository.gen.ts"
  * import { Decision, DecisionPolicy } from "https://deno.land/x/shisho-cloud-sdk/decision/mod.ts"
  * import { wrap_decision_policy } from "https://deno.land/x/shisho-cloud-sdk/decision/raw.ts"
  * import { convert_input, Input } from "./input.ts"
  * 
...
export type CommitSignaturePolicyDefaultParams = { resource_exceptions?: string[] }
...
/** Keep a default branch protected by branch protection rule(s)
  ...
  * @example
  * ```typescript
  * import { default_branch_protection } from "https://deno.land/x/shisho-cloud-sdk/decision/github/repository.gen.ts"
  * import { Decision, DecisionPolicy } from "https://deno.land/x/shisho-cloud-sdk/decision/mod.ts"
  * import { wrap_decision_policy } from "https://deno.land/x/shisho-cloud-sdk/decision/raw.ts"
  * import { convert_input, Input } from "./input.ts"
  * 
...
export const default_branch_protection = (
  ...
  "header": {
    ...
    "type": as_decision_type(default_branch_protection_allowed(decision, params)),
  },
  "payload": decision.payload,
})
...
export type DefaultBranchProtectionDefaultParams = { resource_exceptions?: string[] }
...
/** Ensure force push code to branches is denied
  ...
  * @example
  * ```typescript
  * import { force_push_policy } from "https://deno.land/x/shisho-cloud-sdk/decision/github/repository.gen.ts"
  * import { Decision, DecisionPolicy } from "https://deno.land/x/shisho-cloud-sdk/decision/mod.ts"
  * import { wrap_decision_policy } from "https://deno.land/x/shisho-cloud-sdk/decision/raw.ts"
  * import { convert_input, Input } from "./input.ts"
  * 
...
/** Ensure linear history is required
  ...
  * @example
  * ```typescript
  * import { linear_history_policy } from "https://deno.land/x/shisho-cloud-sdk/decision/github/repository.gen.ts"
  * import { Decision, DecisionPolicy } from "https://deno.land/x/shisho-cloud-sdk/decision/mod.ts"
  * import { wrap_decision_policy } from "https://deno.land/x/shisho-cloud-sdk/decision/raw.ts"
  * import { convert_input, Input } from "./input.ts"
  * 
...
export type LinearHistoryPolicyDefaultParams = { resource_exceptions?: string[] }
...
/** Ensure any change to code receives the enough number of approvals by authenticated users
  ...
  * @example
  * ```typescript
  * import { minimum_approval_number_policy } from "https://deno.land/x/shisho-cloud-sdk/decision/github/repository.gen.ts"
  * import { Decision, DecisionPolicy } from "https://deno.land/x/shisho-cloud-sdk/decision/mod.ts"
  * import { wrap_decision_policy } from "https://deno.land/x/shisho-cloud-sdk/decision/raw.ts"
  * import { convert_input, Input } from "./input.ts"
  * 
...
export const minimum_approval_number_policy = (
  ...
  "header": {
    ...
    "type": as_decision_type(minimum_approval_number_policy_allowed(decision, params)),
  },
  "payload": decision.payload,
})
...
export type MinimumApprovalNumberPolicyDefaultParams = { resource_exceptions?: string[] }

const minimum_approval_number_policy_kind = "github_minimum_approval_number_policy"
...
/** Ensure branch protection rules are enforced for administrators
  ...
  * @example
  * ```typescript
  * import { protection_enforcement_for_admins } from "https://deno.land/x/shisho-cloud-sdk/decision/github/repository.gen.ts"
  * import { Decision, DecisionPolicy } from "https://deno.land/x/shisho-cloud-sdk/decision/mod.ts"
  * import { wrap_decision_policy } from "https://deno.land/x/shisho-cloud-sdk/decision/raw.ts"
  * import { convert_input, Input } from "./input.ts"
  * 
...
export const protection_enforcement_for_admins = (
  ...
  "header": {
    ...
    "type": as_decision_type(protection_enforcement_for_admins_allowed(decision, params)),
  },
  "payload": decision.payload,
})
...
export type ProtectionEnforcementForAdminsDefaultParams = { resource_exceptions?: string[] }

const protection_enforcement_for_admins_kind = "github_protection_enforcement_for_admins"
...
/** Ensure minimum number of administrators are set for the GitHub repository
  ...
  * @example
  * ```typescript
  * import { repo_admins } from "https://deno.land/x/shisho-cloud-sdk/decision/github/repository.gen.ts"
  * import { Decision, DecisionPolicy } from "https://deno.land/x/shisho-cloud-sdk/decision/mod.ts"
  * import { wrap_decision_policy } from "https://deno.land/x/shisho-cloud-sdk/decision/raw.ts"
  * import { convert_input, Input } from "./input.ts"
  * 
...
/** Ensure deletion of GitHub repositories is restricted
  ...
  * @example
  * ```typescript
  * import { repo_members_permission_on_deleting_repository } from "https://deno.land/x/shisho-cloud-sdk/decision/github/repository.gen.ts"
  * import { Decision, DecisionPolicy } from "https://deno.land/x/shisho-cloud-sdk/decision/mod.ts"
  * import { wrap_decision_policy } from "https://deno.land/x/shisho-cloud-sdk/decision/raw.ts"
  * import { convert_input, Input } from "./input.ts"
  * 
...
export const repo_members_permission_on_deleting_repository = (
  ...
  "header": {
    ...
    "type": as_decision_type(repo_members_permission_on_deleting_repository_allowed(decision, params)),
  },
  "payload": decision.payload,
})
...
export type RepoMembersPermissionOnDeletingRepositoryDefaultParams = { resource_exceptions?: string[] }

const repo_members_permission_on_deleting_repository_kind = "github_repo_members_permission_on_deleting_repository"
...
/** Ensure previous approvals are dismissed when updates are introduced to a code change proposal
  ...
  * @example
  * ```typescript
  * import { stale_review_policy } from "https://deno.land/x/shisho-cloud-sdk/decision/github/repository.gen.ts"
  * import { Decision, DecisionPolicy } from "https://deno.land/x/shisho-cloud-sdk/decision/mod.ts"
  * import { wrap_decision_policy } from "https://deno.land/x/shisho-cloud-sdk/decision/raw.ts"
  * import { convert_input, Input } from "./input.ts"
  * 
