 ...
 * @example
 * ```typescript
 * import { org_2fa_status } from "https://deno.land/x/shisho_cloud_policy_helpers/decision/github/organization.gen.ts";
 ...
 * @example
 * ```typescript
 * import { org_default_repository_permission } from "https://deno.land/x/shisho_cloud_policy_helpers/decision/github/organization.gen.ts";
 * import { Decision, DecisionPolicy, decision_policy_adapter } from "https://deno.land/x/shisho_cloud_policy_helpers/decision/mod.ts";
 * import { convert_input, Input } from "./input.gen.ts";
 * // You can generate input.gen.ts by `$ shishoctl codegen typescript-input`
 *
...
export const org_default_repository_permission = (
  ...
  "header": {
    ...
    "type": as_decision_type(
      org_default_repository_permission_allowed(decision, params),
    ),
  },
  "payload": decision.payload,
});
...
export type OrgDefaultRepositoryPermissionDefaultParams = {
  resource_exceptions?: string[];
};

const org_default_repository_permission_kind =
  "github_org_default_repository_permission";
 ...
 * @example
 * ```typescript
 * import { org_members_permission_on_creating_public_pages } from "https://deno.land/x/shisho_cloud_policy_helpers/decision/github/organization.gen.ts";
 * import { Decision, DecisionPolicy, decision_policy_adapter } from "https://deno.land/x/shisho_cloud_policy_helpers/decision/mod.ts";
 * import { convert_input, Input } from "./input.gen.ts";
 * // You can generate input.gen.ts by `$ shishoctl codegen typescript-input`
 *
...
export const org_members_permission_on_creating_public_pages = (
  ...
  "header": {
    ...
    "type": as_decision_type(
      org_members_permission_on_creating_public_pages_allowed(decision, params),
    ),
  },
  "payload": decision.payload,
});
...
export type OrgMembersPermissionOnCreatingPublicPagesDefaultParams = {
  resource_exceptions?: string[];
};

const org_members_permission_on_creating_public_pages_kind =
  "github_org_members_permission_on_creating_public_pages";
 ...
 * @example
 * ```typescript
 * import { org_members_permission_on_creating_public_repos } from "https://deno.land/x/shisho_cloud_policy_helpers/decision/github/organization.gen.ts";
 * import { Decision, DecisionPolicy, decision_policy_adapter } from "https://deno.land/x/shisho_cloud_policy_helpers/decision/mod.ts";
 * import { convert_input, Input } from "./input.gen.ts";
 * // You can generate input.gen.ts by `$ shishoctl codegen typescript-input`
 *
...
export const org_members_permission_on_creating_public_repos = (
  ...
  "header": {
    ...
    "type": as_decision_type(
      org_members_permission_on_creating_public_repos_allowed(decision, params),
    ),
  },
  "payload": decision.payload,
});
...
export type OrgMembersPermissionOnCreatingPublicReposDefaultParams = {
  resource_exceptions?: string[];
};

const org_members_permission_on_creating_public_repos_kind =
  "github_org_members_permission_on_creating_public_repos";
 ...
 * @example
 * ```typescript
 * import { org_members_permission_on_private_forking } from "https://deno.land/x/shisho_cloud_policy_helpers/decision/github/organization.gen.ts";
 * import { Decision, DecisionPolicy, decision_policy_adapter } from "https://deno.land/x/shisho_cloud_policy_helpers/decision/mod.ts";
 * import { convert_input, Input } from "./input.gen.ts";
 * // You can generate input.gen.ts by `$ shishoctl codegen typescript-input`
 *
...
export const org_members_permission_on_private_forking = (
  ...
  "header": {
    ...
    "type": as_decision_type(
      org_members_permission_on_private_forking_allowed(decision, params),
    ),
  },
  "payload": decision.payload,
});
...
export type OrgMembersPermissionOnPrivateForkingDefaultParams = {
  resource_exceptions?: string[];
};

const org_members_permission_on_private_forking_kind =
  "github_org_members_permission_on_private_forking";
 ...
 * @example
 * ```typescript
 * import { org_owners } from "https://deno.land/x/shisho_cloud_policy_helpers/decision/github/organization.gen.ts";
 * import { Decision, DecisionPolicy, decision_policy_adapter } from "https://deno.land/x/shisho_cloud_policy_helpers/decision/mod.ts";
 * import { convert_input, Input } from "./input.gen.ts";
 * // You can generate input.gen.ts by `$ shishoctl codegen typescript-input`
 *
