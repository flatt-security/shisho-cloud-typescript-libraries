...
import { as_decision_type, Decision, is_excepted, Severity, SEVERITY_INFO, SEVERITY_LOW, SEVERITY_MEDIUM, SEVERITY_CRITICAL } from "../../mod.ts"
...
/** Ensure dependencies of GitHub Actions workflows are pinned to verified versions
  ...
  * @example
  * ```typescript
  * import { dependency_pinning } from "https://deno.land/x/shisho-cloud-sdk/decision/github/actions/actions.gen.ts"
...
/** Ensure script evaluation by GitHub Actions workflows is validated
  ...
  * @example
  * ```typescript
  * import { insecure_script_evaluation } from "https://deno.land/x/shisho-cloud-sdk/decision/github/actions/actions.gen.ts"
  * import { Decision, DecisionPolicy } from "https://deno.land/x/shisho-cloud-sdk/decision/mod.ts"
  * import { wrap_decision_policy } from "https://deno.land/x/shisho-cloud-sdk/decision/raw.ts"
  * import { convert_input, Input } from "./input.ts"
  * 
...
export const insecure_script_evaluation = (
  ...
  "header": {
    ...
    "type": as_decision_type(insecure_script_evaluation_allowed(decision, params)),
  },
  "payload": decision.payload,
})
...
export type InsecureScriptEvaluationDefaultParams = { resource_exceptions?: string[] }

const insecure_script_evaluation_kind = "github_actions_insecure_script_evaluation"
...
/** Ensure explicit permissions for GitHub Actions workflows follow organization policies
  ...
  * @example
  * ```typescript
  * import { workflow_explicit_permissions } from "https://deno.land/x/shisho-cloud-sdk/decision/github/actions/actions.gen.ts"
  * import { Decision, DecisionPolicy } from "https://deno.land/x/shisho-cloud-sdk/decision/mod.ts"
  * import { wrap_decision_policy } from "https://deno.land/x/shisho-cloud-sdk/decision/raw.ts"
  * import { convert_input, Input } from "./input.ts"
  * 
...
export const workflow_explicit_permissions = (
  ...
  "header": {
    ...
    "type": as_decision_type(workflow_explicit_permissions_allowed(decision, params)),
  },
  "payload": decision.payload,
})
...
export type WorkflowExplicitPermissionsDefaultParams = { resource_exceptions?: string[] }

const workflow_explicit_permissions_kind = "github_actions_workflow_explicit_permissions"
...
/** Ensure GitHub Actions workflows do not permit any script injections
  ...
  * @example
  * ```typescript
  * import { workflow_script_injection_possibility } from "https://deno.land/x/shisho-cloud-sdk/decision/github/actions/actions.gen.ts"
  * import { Decision, DecisionPolicy } from "https://deno.land/x/shisho-cloud-sdk/decision/mod.ts"
  * import { wrap_decision_policy } from "https://deno.land/x/shisho-cloud-sdk/decision/raw.ts"
  * import { convert_input, Input } from "./input.ts"
  * 
...
export const workflow_script_injection_possibility = (
  ...
  "header": {
    ...
    "type": as_decision_type(workflow_script_injection_possibility_allowed(decision, params)),
  },
  "payload": decision.payload,
})
...
export type WorkflowScriptInjectionPossibilityDefaultParams = { resource_exceptions?: string[] }

const workflow_script_injection_possibility_kind = "github_actions_workflow_script_injection_possibility"
...
/** Ensure secrets do not appear in GitHub Actions Workflows directly
  ...
  * @example
  * ```typescript
  * import { workflow_secret_handling } from "https://deno.land/x/shisho-cloud-sdk/decision/github/actions/actions.gen.ts"
  * import { Decision, DecisionPolicy } from "https://deno.land/x/shisho-cloud-sdk/decision/mod.ts"
  * import { wrap_decision_policy } from "https://deno.land/x/shisho-cloud-sdk/decision/raw.ts"
  * import { convert_input, Input } from "./input.ts"
  * 
...
export const workflow_secret_handling = (
  ...
  "header": {
    ...
    "type": as_decision_type(workflow_secret_handling_allowed(decision, params)),
  },
  "payload": decision.payload,
})
...
export type WorkflowSecretHandlingDefaultParams = { resource_exceptions?: string[] }
