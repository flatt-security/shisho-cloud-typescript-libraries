...
/** Ensure maximum_user_connections database flag for a Cloud SQL for SQL Server instance is set to a non-limiting value
  ...
  * @example
  * ```typescript
  * import { instance_sqlserver_user_connections } from "https://deno.land/x/shisho-cloud-sdk/decision/googlecloud/sql/sql_instance_sqlserver_user_connections.gen.ts"
...
export const instance_sqlserver_user_connections = (
  ...
  "header": {
    ...
    "type": as_decision_type(instance_sqlserver_user_connections_allowed(decision, params)),
  },
...
export type InstanceSqlserverUserConnectionsDefaultParams = { resource_exceptions?: string[] }

const instance_sqlserver_user_connections_kind = "googlecloud_sql_instance_sqlserver_user_connections"
