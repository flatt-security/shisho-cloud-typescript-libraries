...
/** Ensure that the cross_db_ownership_chaining_state  database flag for a Cloud SQL for SQL Server instance is set to off
  ...
  * @example
  * ```typescript
  * import { instance_sqlserver_cross_db_ownership_chaining } from "https://deno.land/x/shisho-cloud-sdk/decision/googlecloud/sql/sql_instance_sqlserver_cross_db_ownership_chaining.gen.ts"
...
export const instance_sqlserver_cross_db_ownership_chaining = (
  ...
  "header": {
    ...
    "type": as_decision_type(instance_sqlserver_cross_db_ownership_chaining_allowed(decision, params)),
  },
...
export type InstanceSqlserverCrossDbOwnershipChainingDefaultParams = { resource_exceptions?: string[] }

const instance_sqlserver_cross_db_ownership_chaining_kind = "googlecloud_sql_instance_sqlserver_cross_db_ownership_chaining"
