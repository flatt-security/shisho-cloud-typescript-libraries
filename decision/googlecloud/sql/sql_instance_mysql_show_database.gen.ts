 ...
 * @example
 * ```typescript
 * import { instance_mysql_show_database } from "https://deno.land/x/shisho_cloud_policy_helpers/decision/googlecloud/sql/sql_instance_mysql_show_database.gen.ts";
...
export const instance_mysql_show_database = (
  ...
  "header": {
    ...
    "type": as_decision_type(
      instance_mysql_show_database_allowed(decision, params),
    ),
  },
...
export type InstanceMysqlShowDatabaseDefaultParams = {
  resource_exceptions?: string[];
};

const instance_mysql_show_database_kind =
  "googlecloud_sql_instance_mysql_show_database";
