...
/** Ensure log_error_verbosity database flag for Cloud SQL for PostgreSQL instance is set to DEFAULT or stricter
  ...
  * @example
  * ```typescript
  * import { instance_postgresql_log_error_verbosity } from "https://deno.land/x/shisho-cloud-sdk/decision/googlecloud/sql/sql_instance_postgresql_log_error_verbosity.gen.ts"
...
export const instance_postgresql_log_error_verbosity = (
  ...
  "header": {
    ...
    "type": as_decision_type(instance_postgresql_log_error_verbosity_allowed(decision, params)),
  },
...
export type InstancePostgresqlLogErrorVerbosityDefaultParams = { resource_exceptions?: string[] }

const instance_postgresql_log_error_verbosity_kind = "googlecloud_sql_instance_postgresql_log_error_verbosity"
