 ...
 * @example
 * ```typescript
 * import { instance_postgresql_log_min_error_statement } from "https://deno.land/x/shisho_cloud_policy_helpers/decision/googlecloud/sql/sql_instance_postgresql_log_min_error_statement.gen.ts";
...
export const instance_postgresql_log_min_error_statement = (
  ...
  "header": {
    ...
    "type": as_decision_type(
      instance_postgresql_log_min_error_statement_allowed(decision, params),
    ),
  },
...
export type InstancePostgresqlLogMinErrorStatementDefaultParams = {
  resource_exceptions?: string[];
};

const instance_postgresql_log_min_error_statement_kind =
  "googlecloud_sql_instance_postgresql_log_min_error_statement";
