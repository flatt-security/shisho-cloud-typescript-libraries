...
/** Ensure that the remote_access_state database flag for a Cloud SQL for SQL Server instance is set to off
  ...
  * @example
  * ```typescript
  * import { instance_sqlserver_remote_access } from "https://deno.land/x/shisho-cloud-sdk/decision/googlecloud/sql/sql_instance_sqlserver_remote_access.gen.ts"
...
export const instance_sqlserver_remote_access = (
  ...
  "header": {
    ...
    "type": as_decision_type(instance_sqlserver_remote_access_allowed(decision, params)),
  },
...
export type InstanceSqlserverRemoteAccessDefaultParams = { resource_exceptions?: string[] }

const instance_sqlserver_remote_access_kind = "googlecloud_sql_instance_sqlserver_remote_access"
