...
/** Ensure that the log_hostname database flag for Cloud SQL for PostgreSQL instance is set to on
  ...
  * @example
  * ```typescript
  * import { instance_postgresql_log_hostname } from "https://deno.land/x/shisho-cloud-sdk/decision/googlecloud/sql/sql_instance_postgresql_log_hostname.gen.ts"
...
export const instance_postgresql_log_hostname = (
  ...
  "header": {
    ...
    "type": as_decision_type(instance_postgresql_log_hostname_allowed(decision, params)),
  },
...
export type InstancePostgresqlLogHostnameDefaultParams = { resource_exceptions?: string[] }

const instance_postgresql_log_hostname_kind = "googlecloud_sql_instance_postgresql_log_hostname"
