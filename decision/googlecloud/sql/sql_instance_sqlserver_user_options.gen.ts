...
/** Ensure user_options_configured database flag for a Cloud SQL for SQL Server instance is not configured
  ...
  * @example
  * ```typescript
  * import { instance_sqlserver_user_options } from "https://deno.land/x/shisho-cloud-sdk/decision/googlecloud/sql/sql_instance_sqlserver_user_options.gen.ts"
...
export const instance_sqlserver_user_options = (
  ...
  "header": {
    ...
    "type": as_decision_type(instance_sqlserver_user_options_allowed(decision, params)),
  },
...
export type InstanceSqlserverUserOptionsDefaultParams = { resource_exceptions?: string[] }

const instance_sqlserver_user_options_kind = "googlecloud_sql_instance_sqlserver_user_options"
