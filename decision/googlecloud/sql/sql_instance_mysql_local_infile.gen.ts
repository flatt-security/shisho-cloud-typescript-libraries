...
/** Ensure that the local_infile database flag for a Cloud SQL for MySQL instance is set to off
  ...
  * @example
  * ```typescript
  * import { instance_mysql_local_infile } from "https://deno.land/x/shisho-cloud-sdk/decision/googlecloud/sql/sql_instance_mysql_local_infile.gen.ts"
...
export const instance_mysql_local_infile = (
  ...
  "header": {
    ...
    "type": as_decision_type(instance_mysql_local_infile_allowed(decision, params)),
  },
...
export type InstanceMysqlLocalInfileDefaultParams = { resource_exceptions?: string[] }

const instance_mysql_local_infile_kind = "googlecloud_sql_instance_mysql_local_infile"
