 ...
 * @example
 * ```typescript
 * import { instance_postgresql_centralized_logging } from "https://deno.land/x/shisho_cloud_policy_helpers/decision/googlecloud/sql/sql_instance_postgresql_centralized_logging.gen.ts";
...
export const instance_postgresql_centralized_logging = (
  ...
  "header": {
    ...
    "type": as_decision_type(
      instance_postgresql_centralized_logging_allowed(decision, params),
    ),
  },
...
export type InstancePostgresqlCentralizedLoggingDefaultParams = {
  resource_exceptions?: string[];
};

const instance_postgresql_centralized_logging_kind =
  "googlecloud_sql_instance_postgresql_centralized_logging";
