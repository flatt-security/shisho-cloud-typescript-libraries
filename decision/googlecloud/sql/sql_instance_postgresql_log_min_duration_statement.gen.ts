...
/** Ensure that the log_min_duration_statement database flag for Cloud SQL for PostgreSQL instance is set to -1
  ...
  * @example
  * ```typescript
  * import { instance_postgresql_log_min_duration_statement } from "https://deno.land/x/shisho-cloud-sdk/decision/googlecloud/sql/sql_instance_postgresql_log_min_duration_statement.gen.ts"
...
export const instance_postgresql_log_min_duration_statement = (
  ...
  "header": {
    ...
    "type": as_decision_type(instance_postgresql_log_min_duration_statement_allowed(decision, params)),
  },
...
export type InstancePostgresqlLogMinDurationStatementDefaultParams = { resource_exceptions?: string[] }

const instance_postgresql_log_min_duration_statement_kind = "googlecloud_sql_instance_postgresql_log_min_duration_statement"
