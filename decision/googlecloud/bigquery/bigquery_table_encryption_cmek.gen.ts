 ...
 * @example
 * ```typescript
 * import { table_encryption_cmek } from "https://deno.land/x/shisho_cloud_policy_helpers/decision/googlecloud/bigquery/bigquery_table_encryption_cmek.gen.ts";
...
export type TableEncryptionCmekDefaultParams = {
