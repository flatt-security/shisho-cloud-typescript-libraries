...
/** Ensure BigQuery tables use Customer-Managed Encryption Keys (CMEK)
  ...
  * @example
  * ```typescript
  * import { dataset_encryption_cmek } from "https://deno.land/x/shisho-cloud-sdk/decision/googlecloud/bigquery/bigquery_dataset_encryption_cmek.gen.ts"
...
export type DatasetEncryptionCmekDefaultParams = { resource_exceptions?: string[] }

const dataset_encryption_cmek_kind = "googlecloud_bigquery_dataset_encryption_cmek"
