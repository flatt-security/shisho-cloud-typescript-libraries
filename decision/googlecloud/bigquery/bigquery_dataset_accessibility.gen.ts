...
/** Ensure BigQuery dataset accessibility is restricted to a minimum level
  ...
  * @example
  * ```typescript
  * import { dataset_accessibility } from "https://deno.land/x/shisho-cloud-sdk/decision/googlecloud/bigquery/bigquery_dataset_accessibility.gen.ts"
...
export type DatasetAccessibilityDefaultParams = { resource_exceptions?: string[] }
