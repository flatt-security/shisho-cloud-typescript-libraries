 ...
 * @example
 * ```typescript
 * import { service_account_admin_separation } from "https://deno.land/x/shisho_cloud_policy_helpers/decision/googlecloud/iam/iam_service_account_admin_separation.gen.ts";
...
export const service_account_admin_separation = (
  ...
  "header": {
    ...
    "type": as_decision_type(
      service_account_admin_separation_allowed(decision, params),
    ),
  },
...
export type ServiceAccountAdminSeparationDefaultParams = {
  resource_exceptions?: string[];
};

const service_account_admin_separation_kind =
  "googlecloud_iam_service_account_admin_separation";
