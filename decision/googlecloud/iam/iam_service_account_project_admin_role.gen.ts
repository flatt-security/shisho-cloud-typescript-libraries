...
/** Ensure Google Cloud service accounts have admin privileges only when truly required
  ...
  * @example
  * ```typescript
  * import { service_account_project_admin_role } from "https://deno.land/x/shisho-cloud-sdk/decision/googlecloud/iam/iam_service_account_project_admin_role.gen.ts"
...
export const service_account_project_admin_role = (
  ...
  "header": {
    ...
    "type": as_decision_type(service_account_project_admin_role_allowed(decision, params)),
  },
...
export type ServiceAccountProjectAdminRoleDefaultParams = { resource_exceptions?: string[] }

const service_account_project_admin_role_kind = "googlecloud_iam_service_account_project_admin_role"
