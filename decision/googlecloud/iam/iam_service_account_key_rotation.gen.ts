 ...
 * @example
 * ```typescript
 * import { service_account_key_rotation } from "https://deno.land/x/shisho_cloud_policy_helpers/decision/googlecloud/iam/iam_service_account_key_rotation.gen.ts";
  ...
  "header": {
    ...
    "annotations": {
      ...
      "decision.api.shisho.dev:googlecloud/scc-premium/latest":
        "IAM_SCANNER.SERVICE_ACCOUNT_KEY_NOT_ROTATED",
      "decision.api.shisho.dev:needs-manual-review": "false",
      "decision.api.shisho.dev:ssc/category": "infrastructure",
    },
    "type": as_decision_type(
      service_account_key_rotation_allowed(decision, params),
    ),
  },
...
export type ServiceAccountKeyRotationDefaultParams = {
  resource_exceptions?: string[];
};

const service_account_key_rotation_kind =
  "googlecloud_iam_service_account_key_rotation";
