 ...
 * @example
 * ```typescript
 * import { service_account_key } from "https://deno.land/x/shisho_cloud_policy_helpers/decision/googlecloud/iam/iam_service_account_key.gen.ts";
  ...
  "header": {
    ...
    "annotations": {
      ...
      "decision.api.shisho.dev:googlecloud/scc-premium/latest":
        "IAM_SCANNER.USER_MANAGED_SERVICE_ACCOUNT_KEY",
