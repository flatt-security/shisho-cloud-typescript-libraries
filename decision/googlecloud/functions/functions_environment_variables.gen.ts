...
/** Ensure secrets are not stored in Cloud Functions environment variables
  ...
  * @example
  * ```typescript
  * import { environment_variables } from "https://deno.land/x/shisho-cloud-sdk/decision/googlecloud/functions/functions_environment_variables.gen.ts"
...
export type EnvironmentVariablesDefaultParams = { resource_exceptions?: string[] }

const environment_variables_kind = "googlecloud_functions_environment_variables"
