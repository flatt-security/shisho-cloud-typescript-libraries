...
/** Ensure the Zone-Signing Key in Cloud DNS uses a secure algorithm
  ...
  * @example
  * ```typescript
  * import { dnssec_zsk_algorithm } from "https://deno.land/x/shisho-cloud-sdk/decision/googlecloud/dns/dns_dnssec_zsk_algorithm.gen.ts"
...
export type DnssecZskAlgorithmDefaultParams = { resource_exceptions?: string[] }
