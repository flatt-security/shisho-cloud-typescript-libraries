...
/** Ensure the Key-Signing Key in Cloud DNS uses a secure algorithm
  ...
  * @example
  * ```typescript
  * import { dnssec_ksk_algorithm } from "https://deno.land/x/shisho-cloud-sdk/decision/googlecloud/dns/dns_dnssec_ksk_algorithm.gen.ts"
...
export type DnssecKskAlgorithmDefaultParams = { resource_exceptions?: string[] }
