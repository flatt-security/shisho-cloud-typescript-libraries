 ...
 * @example
 * ```typescript
 * import { bucket_retention_policy } from "https://deno.land/x/shisho_cloud_policy_helpers/decision/googlecloud/logging/logging_bucket_retention_policy.gen.ts";
...
export type BucketRetentionPolicyDefaultParams = {
  resource_exceptions?: string[];
};

const bucket_retention_policy_kind =
  "googlecloud_logging_bucket_retention_policy";
