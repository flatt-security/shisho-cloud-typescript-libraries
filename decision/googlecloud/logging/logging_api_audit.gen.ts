...
/** Ensure Cloud Audit Logging is configured to record API operations
  ...
  * @example
  * ```typescript
  * import { api_audit, AUDIT_LOG_CONFIG_LOG_TYPE_LOG_TYPE_UNSPECIFIED } from "https://deno.land/x/shisho-cloud-sdk/decision/googlecloud/logging/logging_api_audit.gen.ts"
...
type ApiAuditDecisionArgs = {
  ...
  locator?: string
  payload: {
    audit_configs: { service: string, audit_log_configs: { audit_log_config_log_type: AuditLogConfigLogType, exempted_members: string[] }[] }[]
  }
