 ...
 * @example
 * ```typescript
 * import { bucket_uniform_bucket_level_access } from "https://deno.land/x/shisho_cloud_policy_helpers/decision/googlecloud/storage/storage_bucket_uniform_bucket_level_access.gen.ts";
...
export const bucket_uniform_bucket_level_access = (
  ...
  "header": {
    ...
    "type": as_decision_type(
      bucket_uniform_bucket_level_access_allowed(decision, params),
    ),
  },
...
export type BucketUniformBucketLevelAccessDefaultParams = {
  resource_exceptions?: string[];
};

const bucket_uniform_bucket_level_access_kind =
  "googlecloud_storage_bucket_uniform_bucket_level_access";
