...
/** Ensure Cloud Storage buckets are public only if intended
  ...
  * @example
  * ```typescript
  * import { bucket_accessibility } from "https://deno.land/x/shisho-cloud-sdk/decision/googlecloud/storage/storage_bucket_accessibility.gen.ts"
...
export type BucketAccessibilityDefaultParams = { resource_exceptions?: string[] }
