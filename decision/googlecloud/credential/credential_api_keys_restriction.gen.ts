...
/** Ensure API Keys are restricted to usage by only specified hosts and apps
  ...
  * @example
  * ```typescript
  * import { api_keys_restriction, RESTRICTION_TYPE_NO_RESTRICTION } from "https://deno.land/x/shisho-cloud-sdk/decision/googlecloud/credential/credential_api_keys_restriction.gen.ts"
...
export type ApiKeysRestrictionDefaultParams = { resource_exceptions?: string[] }
