 ...
 * @example
 * ```typescript
 * import { dns_log } from "https://deno.land/x/shisho_cloud_policy_helpers/decision/googlecloud/networking/networking_dns_log.gen.ts";
  ...
  "header": {
    ...
    "annotations": {
      ...
      "decision.api.shisho.dev:googlecloud/scc-premium/latest":
        "FIREWALL_SCANNER.EGRESS_DENY_RULE_NOT_SET",
