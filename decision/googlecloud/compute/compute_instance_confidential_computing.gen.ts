...
/** Ensure that Confidential VM for Compute Engine instances is enabled
  ...
  * @example
  * ```typescript
  * import { instance_confidential_computing, CONFIDENTIAL_COMPUTING_STATUS_UNSUPPORTED } from "https://deno.land/x/shisho-cloud-sdk/decision/googlecloud/compute/compute_instance_confidential_computing.gen.ts"
...
export const instance_confidential_computing = (
  ...
  "header": {
    ...
    "type": as_decision_type(instance_confidential_computing_allowed(decision, params)),
  },
...
export type InstanceConfidentialComputingDefaultParams = { resource_exceptions?: string[] }

const instance_confidential_computing_kind = "googlecloud_compute_instance_confidential_computing"
