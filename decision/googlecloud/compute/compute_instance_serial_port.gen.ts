 ...
 * @example
 * ```typescript
 * import { instance_serial_port } from "https://deno.land/x/shisho_cloud_policy_helpers/decision/googlecloud/compute/compute_instance_serial_port.gen.ts";
...
export type InstanceSerialPortDefaultParams = {
