 ...
 * @example
 * ```typescript
 * import { instance_ip_forwarding } from "https://deno.land/x/shisho_cloud_policy_helpers/decision/googlecloud/compute/compute_instance_ip_forwarding.gen.ts";
  ...
  "header": {
    ...
    "annotations": {
      ...
      "decision.api.shisho.dev:googlecloud/scc-premium/latest":
        "COMPUTE_INSTANCE_SCANNER.IP_FORWARDING_ENABLED",
...
export type InstanceIpForwardingDefaultParams = {
  resource_exceptions?: string[];
};

const instance_ip_forwarding_kind =
  "googlecloud_compute_instance_ip_forwarding";
