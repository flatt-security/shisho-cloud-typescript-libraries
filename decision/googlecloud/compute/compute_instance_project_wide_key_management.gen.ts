...
/** Ensure Compute Engine instances block project-wide SSH keys
  ...
  * @example
  * ```typescript
  * import { instance_project_wide_key_management } from "https://deno.land/x/shisho-cloud-sdk/decision/googlecloud/compute/compute_instance_project_wide_key_management.gen.ts"
...
export const instance_project_wide_key_management = (
  ...
  "header": {
    ...
    "type": as_decision_type(instance_project_wide_key_management_allowed(decision, params)),
  },
...
export type InstanceProjectWideKeyManagementDefaultParams = { resource_exceptions?: string[] }

const instance_project_wide_key_management_kind = "googlecloud_compute_instance_project_wide_key_management"
