...
/** Ensure Compute Engine instances enable Shielded VM features
  ...
  * @example
  * ```typescript
  * import { instance_shielded_vm } from "https://deno.land/x/shisho-cloud-sdk/decision/googlecloud/compute/compute_instance_shielded_vm.gen.ts"
...
export type InstanceShieldedVmDefaultParams = { resource_exceptions?: string[] }
