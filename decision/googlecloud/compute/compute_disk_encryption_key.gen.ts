 ...
 * @example
 * ```typescript
 * import { disk_encryption_key, ENCRYPTION_KEY_TYPE_ENCRYPTION_KEY_TYPE_UNKNOWN } from "https://deno.land/x/shisho_cloud_policy_helpers/decision/googlecloud/compute/compute_disk_encryption_key.gen.ts";
