 ...
 * @example
 * ```typescript
 * import { instance_service_account } from "https://deno.land/x/shisho_cloud_policy_helpers/decision/googlecloud/compute/compute_instance_service_account.gen.ts";
...
export const instance_service_account = (
  ...
  "header": {
    ...
    "type": as_decision_type(
      instance_service_account_allowed(decision, params),
    ),
  },
...
export type InstanceServiceAccountDefaultParams = {
  resource_exceptions?: string[];
};

const instance_service_account_kind =
  "googlecloud_compute_instance_service_account";
