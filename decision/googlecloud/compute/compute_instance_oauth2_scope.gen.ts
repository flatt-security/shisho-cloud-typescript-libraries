...
/** Ensure that Compute Engine instances use appropriate OAuth2 scopes for Google APIs
  ...
  * @example
  * ```typescript
  * import { instance_oauth2_scope } from "https://deno.land/x/shisho-cloud-sdk/decision/googlecloud/compute/compute_instance_oauth2_scope.gen.ts"
...
export type InstanceOauth2ScopeDefaultParams = { resource_exceptions?: string[] }
