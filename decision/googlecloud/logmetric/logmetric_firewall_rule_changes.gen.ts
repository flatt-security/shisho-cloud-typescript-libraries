 ...
 * @example
 * ```typescript
 * import { firewall_rule_changes } from "https://deno.land/x/shisho_cloud_policy_helpers/decision/googlecloud/logmetric/logmetric_firewall_rule_changes.gen.ts";
...
export type FirewallRuleChangesDefaultParams = {
  resource_exceptions?: string[];
};

const firewall_rule_changes_kind =
  "googlecloud_logmetric_firewall_rule_changes";
