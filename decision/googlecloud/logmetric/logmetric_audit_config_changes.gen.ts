...
/** Ensure that the log metric filter and alerts exist for audit configuration changes
  ...
  * @example
  * ```typescript
  * import { audit_config_changes } from "https://deno.land/x/shisho-cloud-sdk/decision/googlecloud/logmetric/logmetric_audit_config_changes.gen.ts"
...
export type AuditConfigChangesDefaultParams = { resource_exceptions?: string[] }
