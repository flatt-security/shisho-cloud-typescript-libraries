...
/** Update packages with known vulnerabilities
  ...
  * @example
  * ```typescript
  * import { package_known_vulnerability } from "https://deno.land/x/shisho-cloud-sdk/decision/dependency/package.gen.ts"
...
export const package_known_vulnerability = (
  ...
  "header": {
    ...
    "type": as_decision_type(package_known_vulnerability_allowed(decision, params)),
  },
...
export type PackageKnownVulnerabilityDefaultParams = { resource_exceptions?: string[] }
